...
| `/mapr/<type>/`                   | GET    | <code>type=(gene&#124;phenotype&#124;cellline&#124;sirna&#124;antibody&#124;compound&#124;organism)</code>                                       | `value=<value>` <code>query=(true&#124;false)</code> `default:false`                                | 200 HTML         |                                                   | `/mapr/gene/?value=CDC20` `/mapr/organism/?value=CDC2&query=true`                                                                                                                                                                                                                                                                                                                  |
...
| `/mapr/autocomplete/<type>/` | GET    | <code>type=(gene&#124;phenotype&#124;cellline&#124;sirna&#124;antibody&#124;compound&#124;organism)</code>                                       | `value=<value>` `query=true`                                                        | 200 JSON         |                                                   | find keywords for matching `%value%` pattern                                                                                                                                                                                                                                                                                                                                                              |
